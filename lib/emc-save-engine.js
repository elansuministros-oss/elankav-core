...
async function guardarEMC(body, supabase) {
...
module.exports = {
  guardarEMC,
  guardarCatalogoEMC: guardarEMC,
  guardarItemsEMC: guardarEMC,
  saveEMC: guardarEMC,
  saveEMCItems: guardarEMC,
};