...
export async function runElanAiSalesOrchestrator({ normalized = {}, now = new Date() } = {}) {
  ...
  const generatorContext = {
    ...
    campaignContext: {
      id: "rotuloLuminosoGym01",
      name: "Rótulo Luminoso Gym 01",
      product: "Rótulo luminoso tipo caja de luz",
      priceCommunication: "Disponible desde USD 350 en tamaño estándar de 1.10 metros de ancho. Precio final varía según tamaño, materiales e instalación.",
    },
